...
import com.devshadat.note_app_kotlin.databinding.FragmentAddNoteBinding
...
class AddNoteFragment : Fragment() {
    ...
    private fun bind(item: Note) {
        binding.apply {
            noteTitle.setText(item.noteTitle, TextView.BufferType.SPANNABLE)
            noteDetail.setText(item.noteDetail, TextView.BufferType.SPANNABLE)
